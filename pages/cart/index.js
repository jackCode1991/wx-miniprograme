...
Page({
    ...
    onLoad() {
        this.queryCarProduct = App.HttpResource('/weChatMall/queryCarProduct/:id', {openId: '@id'})
    },
    onShow() {
        this.getCarts()
    },
    getCarts() {
        App.HttpService.getCartByOpenId('oAv2w07K6_YrG4nW9qvEGMy2ydY8')
        //console.log(App.globalData.userInfo)
        //this.queryCarProduct.getAsync({openId: 'oAv2w07K6_YrG4nW9qvEGMy2ydY8'})
        .then(res => {
            const data = res.data
            console.log(data)
            if (data.code == 200) {
